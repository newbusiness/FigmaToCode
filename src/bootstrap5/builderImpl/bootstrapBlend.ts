 ...
 */
export const bootstrapOpacity = (node: AltBlendMixin): string => {
 ...
 * example: invisible
 */
export const bootstrapVisibility = (node: AltSceneNode): string => {
 ...
 */
export const bootstrapRotation = (node: AltLayoutMixin): string => {
